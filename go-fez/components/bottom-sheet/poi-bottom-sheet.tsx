      ...
      <View style={styles.section}>
        ...
        <View style={styles.audioGuideContainer}>
          <TouchableOpacity style={styles.playButton}>
            <FontAwesome5 name='play' size={20} color='#ff822e' />
          </TouchableOpacity>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoContent}>
            ...
            <View className='flex-row gap-2 mt-2'>
              <Feather name='globe' size={18} color='#ff822e' />
              <TouchableOpacity>
                <Link
      ...
      >
        <View style={styles.businessStatusRow}>
          ...
          <TouchableOpacity style={styles.statusBadge}>
            <Text style={[styles.statusText, { color: '#ff822e' }]}>
              Open now
            </Text>
